<header id="header" class="position-sticky d-flex flex-wrap align-items-center justify-content-center justify-content-md-between border-bottom bg-primary">
    <a href="../dashboard" class="d-flex align-items-center col-md-3 mb-2 mb-md-0  text-dark text-decoration-none" style="pointer-events: none;">
    ...
    <div class=" w-50 d-flex" style="margin-left: 12em;">
        <h2 class="text-info">ASSACOM</h2>
    </div>

    <a href="../profile" class="me-5">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="<?= basename(getcwd()) == "profile" ? "cyan" : "black" ?>" class="bi bi-person-circle" viewBox="0 0 16 16">
